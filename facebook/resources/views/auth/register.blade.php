                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }} " enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="username" class="mb-6"> User Name : </label>
                        ...
                        <div class="form-group row">
                            <label for="name" class="mb-6">{{ __('Name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="email" class="mb-6">{{ __('E-Mail Address') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password" class="mb-6">{{ __('Password') }}</label>
                        ...
                        <div class="form-group row mb-6">
                            <label for="password-confirm" class="mb-6">{{ __('Confirm Password') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="avatar" class="mb-6"> Avatar : </label>

                            <div class="col-md-6">
                                <input id="avatar" type="file" class="border border-gray-400 p-2 w-full @error('avatar') is-invalid @enderror" name="avatar" value="{{ old('avatar') }}" required autocomplete="avatar" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cover" type="file" class="border border-gray-400 p-2 w-full @error('cover') is-invalid @enderror" name="cover" value="{{ old('cover') }}" required autocomplete="cover" autofocus>
