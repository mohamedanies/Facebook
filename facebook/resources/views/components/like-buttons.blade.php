<div class="flex">
    ...
    <div class="flex items-center mr-4  mt-2 mb-2 {{ $post->isLikedBy(current_user()) ? 'text-red-700' : 'text-black' }}">
       <svg viewBox="0 0 20 20" class="mr-2 w-5">
   ...
   <form action="/posts/{{ $post->id }}/like" 
       ...
       @method('DELETE')
    <div class="flex items-center mt-2 mb-2 {{ $post->isDislikedBy(current_user()) ? 'text-red-700' : 'text-black' }}">
    <svg viewBox="0 0 20 20" class="mr-2 w-5">
